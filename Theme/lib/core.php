...
class Bunyad_Core
{
	...
	{	
		...
		$text['category'] = __('Categoría: "%s"', 'bunyad'); // text for a category page
		$text['tax'] 	  = __('Archivo para "%s"', 'bunyad'); // text for a taxonomy page
		$text['search']   = __('Buscar resultados para "%s"', 'bunyad'); // text for a search results page
		$text['tag']      = __('Posts Tagged "%s"', 'bunyad'); // text for a tag page
		$text['author']   = __('Autor: %s', 'bunyad'); // text for an author page
		...
		$defaults = array(
			...
			'home_before' => '<span class="location">'. __(' ', 'bunyad') .'</span>',
			'home_after' => '',
			'home_link' => home_url() . '/',

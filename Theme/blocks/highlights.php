	...
	<section class="highlights">
		...
		<?php if ($heading == 'section-head'): ?>
			...
			<div class="section-head cat-text-<?php echo $taxonomy->term_id; ?>">
				<a href="<?php echo esc_url($link); ?>"><?php echo esc_html($title); ?> <i class="fa fa-plus"></i></a>
			</div>
		...
		<?php if ($count === 1): // main post - better highlighted ?>
			...
			<?php if ($heading != 'section-head'): ?>
				<span class="cat-title larger cat-<?php echo $taxonomy->term_id; ?>">
					<a href="<?php echo esc_url($link); ?>"><?php echo esc_html($title); ?> <i class="fa fa-plus"></i></a></span>
			<?php endif; ?>
		...
		<?php if ($query->post_count > 1): ?>
			...
			<ul class="block <?php echo ($type == 'posts-list'); ?>">
				...
				<li>
					...
					<div class="content">
						...
						*/ ?>
						...
						<i class="fa fa-angle-right"></i> <time datetime="<?php echo get_the_date('Y-m-d\TH:i:sP'); ?>"><?php echo get_the_date(); ?> </time>
					<br>						
